...
import intro_gym from "../../images/intro_gym.jpg";
  ...
  return (
    <div className="min-h-screen bg-white text-black pb-6 px-3 sm:px-0 font-sans">
      <div className="text-center">
        {/* FitHarmony 소개 문구 */}
        <div
          className="mt-4 sm:mt-0 mb-12 relative rounded-[20px] sm:rounded-none"
          style={{
            backgroundImage: `url(${intro_gym})`,
