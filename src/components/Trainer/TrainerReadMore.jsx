        ...
        <div className="bg-gradient-to-r from-yellow-100/90 to-lime-100/90 backdrop-blur-xl rounded-[2.5rem] p-10 mb-8 shadow-2xl border border-lime-200/50 relative overflow-hidden">
          ...
          <div className="flex items-center gap-10 mb-10 max-lg:flex-col max-lg:text-center relative z-10">
            ...
            <div className="flex-1">
              ...
              <p className="text-2xl text-gray-700 mb-6 font-medium">건강한 변화의 시작, 함께 만들어가요</p>
              ...
              <div className="flex items-center gap-8 max-lg:justify-center flex-wrap">
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl px-6 py-4 shadow-lg border border-lime-200/50">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-2xl font-bold text-lime-700">4.9</div>
                      <div className="text-sm text-gray-600">평점 (124개 리뷰)</div>
                    </div>
                  </div>
                </div>
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl px-6 py-4 shadow-lg border border-lime-200/50">
                  <div className="flex items-center gap-3">
                    <span className="text-2xl">🏆</span>
                    <div>
                      <div className="text-2xl font-bold text-lime-700">3년</div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-br from-yellow-100/90 to-lime-100/90 backdrop-blur-xl rounded-[2rem] p-8 shadow-2xl border border-lime-200/50 relative overflow-hidden">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 relative z-10">
                ...
                >
                  ...
                  <h3 className="text-xl font-bold text-lime-700 mb-2">기초 PT 클래스</h3>
                  <div className="text-3xl font-bold text-gray-800 mb-4 bg-gradient-to-r from-lime-600 to-green-600 bg-clip-text text-transparent">80,000원</div>
                  <p className="text-gray-600 leading-relaxed">
                    운동 초보자를 위한 기본 자세부터 운동 루틴까지 배우는 클래스입니다. 
                    개인 맞춤형 트레이닝으로 진행됩니다.
                  </p>
                ...
                >
                  ...
                  <div className="text-3xl mb-3">💪</div>
                  <h3 className="text-xl font-bold text-lime-700 mb-2">웨이트 트레이닝</h3>
                  <div className="text-3xl font-bold text-gray-800 mb-4 bg-gradient-to-r from-lime-600 to-green-600 bg-clip-text text-transparent">100,000원</div>
                  <p className="text-gray-600 leading-relaxed">
                ...
                >
                  ...
                  <div className="text-3xl mb-3">🏆</div>
                  <h3 className="text-xl font-bold text-lime-700 mb-2">프리미엄 코스</h3>
                  <div className="text-3xl font-bold text-gray-800 mb-4 bg-gradient-to-r from-lime-600 to-green-600 bg-clip-text text-transparent">300,000원</div>
                  <p className="text-gray-600 leading-relaxed">
                    4주 연속 수업으로 구성된 종합 피트니스 코스입니다. 
                    유산소, 근력, 체형 교정을 모두 포함합니다.
                  </p>
                  <div className="mt-4 text-sm text-lime-600 font-semibold group-hover:text-lime-700 transition-colors">
                    자세히 보기 →
                  </div>
            ...
            <div className="bg-gradient-to-br from-lime-100/90 to-green-100/90 backdrop-blur-xl rounded-[2rem] p-8 shadow-2xl border border-lime-200/50 relative overflow-hidden">
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-lime-200/30 relative z-10">
                <p className="leading-8 text-gray-700 text-lg">
                  안녕하세요! 건강한 삶을 추구하는 <strong className="text-lime-700">{trainerDetail.userName}</strong> 트레이너입니다. 🌟<br /><br />
                  
                  저는 체육학과를 졸업하고 NSCA-CPT 자격증을 보유하고 있으며, 
                  3년간 다양한 연령대의 회원들과 함께 건강한 라이프스타일을 만들어가고 있습니다.<br /><br />
                  
                  <strong className="text-lime-700 text-xl">🎯 트레이닝 특징:</strong><br />
                  ...
                  운동이 처음이신 분부터 실력을 더 키우고 싶은 분까지, 
                  모든 레벨의 회원들을 환영합니다! 함께 건강한 몸을 만들어보아요! 💪
                </p>
              </div>
            </div>
              ...
              <div className="space-y-6 relative z-10">
                <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 shadow-lg border-l-4 border-lime-500 hover:shadow-xl transition-shadow duration-300">
                  <div className="flex justify-between items-center mb-4">
                    <span className="font-bold text-gray-800 text-lg">박***</span>
                ...
                <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 shadow-lg border-l-4 border-lime-500 hover:shadow-xl transition-shadow duration-300">
                  <div className="flex justify-between items-center mb-4">
                    <span className="font-bold text-gray-800 text-lg">김***</span>
                    <div className="flex items-center gap-1">
                      <span className="text-yellow-400 text-xl">⭐⭐⭐⭐⭐</span>
                    </div>
                  </div>
                  <p className="text-gray-600 leading-relaxed text-lg">
                    웨이트 트레이닝 정말 만족스러웠어요. 
                    자세 교정과 운동법을 정확히 알려주셔서 효과를 바로 느꼈습니다!
                  </p>
                </div>
                
                <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 shadow-lg border-l-4 border-lime-500 hover:shadow-xl transition-shadow duration-300">
                  <div className="flex justify-between items-center mb-4">
                    <span className="font-bold text-gray-800 text-lg">이***</span>
                    <div className="flex items-center gap-1">
                      <span className="text-yellow-400 text-xl">⭐⭐⭐⭐⭐</span>
                    </div>
                  </div>
                  <p className="text-gray-600 leading-relaxed text-lg">
                    프리미엄 코스 완주했습니다! 
                    4주 동안 정말 많이 배웠고, 이제 건강한 운동 습관을 가지게 되었어요.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-gradient-to-br from-lime-100/90 to-green-100/90 backdrop-blur-xl rounded-[2rem] p-8 shadow-2xl border border-lime-200/50 h-fit relative overflow-hidden">
            ...
            <div className="space-y-4 mb-8 relative z-10">
              ...
              >
                <div className="w-12 h-12 bg-gradient-to-br from-lime-400 to-lime-500 rounded-full flex items-center justify-center text-white text-lg shadow-lg">📱</div>
                <span className="text-gray-700 font-medium text-lg">010-1234-5678</span>
              </div>
              <div 
                onClick={() => handleContactClick('email', 'trainer@example.com')}
                className="group flex items-center gap-4 p-4 bg-white/80 backdrop-blur-sm rounded-xl cursor-pointer hover:bg-white hover:shadow-lg hover:translate-x-2 transition-all duration-300 border border-lime-200/50"
              >
                <div className="w-12 h-12 bg-gradient-to-br from-lime-400 to-lime-500 rounded-full flex items-center justify-center text-white text-lg shadow-lg">✉️</div>
                <span className="text-gray-700 font-medium text-lg">trainer@example.com</span>
              </div>
              <div 
                onClick={() => handleContactClick('location', trainerDetail.gym?.gymName || '서울시 강남구')}
                className="group flex items-center gap-4 p-4 bg-white/80 backdrop-blur-sm rounded-xl cursor-pointer hover:bg-white hover:shadow-lg hover:translate-x-2 transition-all duration-300 border border-lime-200/50"
              >
                <div className="w-12 h-12 bg-gradient-to-br from-lime-400 to-lime-500 rounded-full flex items-center justify-center text-white text-lg shadow-lg">🏠</div>
                <span className="text-gray-700 font-medium text-lg">{trainerDetail.gym?.gymName || '서울시 강남구'}</span>
              </div>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 text-center mb-8 shadow-lg border border-lime-200/50 relative z-10">
              ...
              <p className="text-gray-700 font-medium text-lg">
                {trainerDetail.gym?.gymName || '헬스장 정보'}<br />
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 mb-8 shadow-lg border border-lime-200/50 relative z-10">
              <div className="space-y-3 text-lg">
                <p className="flex justify-between"><strong>평일:</strong> <span className="text-lime-600">06:00 - 22:00</span></p>
                <p className="flex justify-between"><strong>주말:</strong> <span className="text-lime-600">08:00 - 20:00</span></p>
                <p className="flex justify-between text-orange-600 font-semibold"><strong>휴무:</strong> <span>매주 일요일</span></p>
              </div>
            </div>
